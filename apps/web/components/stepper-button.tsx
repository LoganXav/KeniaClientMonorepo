...
export default function StepperButton({ children, className, step, selected, stepper, i, completedSteps, complete }: StepperButtonProps) {
  ...
  return (
    <Button
      variant="outline"
      className={cn("flex min-w-64 justify-between border-border whitespace-nowrap", className, selected && "bg-transparent/5 border-foreground", isCompleted && "bg-transparent/5")}
