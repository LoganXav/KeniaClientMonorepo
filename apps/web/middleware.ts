...
const protectedRoutes = [RouteEnums.DASHBOARD, RouteEnums.STAFF, RouteEnums.STUDENT, RouteEnums.SCHOOL, RouteEnums.CLASS, RouteEnums.SUBJECT, RouteEnums.ANALYTICS];
